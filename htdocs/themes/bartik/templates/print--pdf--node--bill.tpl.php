<?php
  ...
  // PAYCURRENCYCODE
  $payment_code = 'EUR';
  if (strpos($content['field_grand_total_in_payment']['und'][0]["value"], 'EUR') === FALSE) {
    $payment_code = '$';
    ...
    $raw_items .=
      '<div class="bill-items" style="border-bottom: 0.1mm solid grey; border-top: 0.1mm solid grey; display: table-row; position: relative; width: 100%; font-weight: bold">
        ...
        <div style="border-bottom: 0.1mm solid grey; width: 2.25cm; display: table-cell; border-left: 0.1mm solid grey; text-align: right; padding-left: 2mm; padding-right: 2mm">
          ' . number_format(($content['field_bill_items_unit_price']['und'][$key]["value"] * ($add_vat ==1 ? 0.81 : 1)), 2, ',', '.') . ' €
        </div>
        <div style="border-bottom: 0.1mm solid grey; width: 2.25cm; display: table-cell; border-left: 0.1mm solid grey; text-align: right; padding-left: 2mm; padding-right: 2mm">
          ' . number_format(($content['field_bill_items_total_price']['und'][$key]["value"] * ($add_vat ==1 ? 0.81 : 1)), 2, ',', '.') . ' €
        </div>
      </div>'    
    ;
  }
...
<div style="margin: 0.0cm; position: relative; font-size: 9px; width: 100%">
  ...
  <div style="border-bottom: 0.1mm solid grey; position: relative; display: table; width: 100%">
    <div style="display: table-row; position: relative">
      <div style="border-left: 0.1mm solid grey; width: 11.4cm; display: table-cell; padding-left: 2mm">
        <div style="font-size: 6px"><?php print $bricks_address_small; ?></div>
        <br />
        <?php print $content['field_bill_address']['und']['0']['value']; ?>
      </div>
      <div style="border-right: 0.1mm solid grey; position: relative; border-left: 0.1mm solid grey; display: table-cell; width: auto; padding-left: 2mm">
        <?php print $bricks_address_big; ?>
      </div>
    </div>    
  </div>
  
  <div style="border-left: 0.1mm solid grey; border-right: 0.1mm solid grey; font-size: 14px; font-weight: bold; text-align: center; position: relative; border-bottom: 0.1mm solid grey">
  ...
  <div style="border-bottom: 0.1mm solid grey; position: relative; display: table; width: 100%">
    <div style="display: table-row; position: relative">
      <div style="border-left: 0.1mm solid grey; width: 11.4cm; display: table-cell; padding-left: 2mm">
        <?php print $bricks_bill_number; ?><?php print $content['field_bill_number']['und']['0']['value']; ?>
        <br /><br />
  ...
  <div style="position: relative; display: table; font-size: 8px; border-collapse: collapse; margin-left: auto; margin-right: auto; border-left: 0.1mm solid grey; border-right: 0.1mm solid grey">
    <div style="border-bottom: 0.1mm solid grey; border-top: 0.1mm solid grey; display: table-row; position: relative; font-weight: bold">
      <div style="border-top: 0.1mm solid grey; border-bottom: 0.1mm solid grey; width: 0.75cm; display: table-cell; padding-left: 2mm; padding-right: 2mm">
        <?php print $bricks_bill_table_header_item; ?>
      </div>
      <div style="border-top: 0.1mm solid grey; border-bottom: 0.1mm solid grey; width: 0.75cm; display: table-cell; padding-left: 2mm; padding-right: 2mm; border-left: 0.1mm solid grey">
        <?php print $bricks_bill_table_header_artno; ?>
      </div>
      <div style="border-top: 0.1mm solid grey; border-bottom: 0.1mm solid grey; width: 5.0cm; display: table-cell; padding-left: 2mm; padding-right: 2mm; border-left: 0.1mm solid grey">
        <?php print $bricks_bill_table_header_desc; ?>
      </div>
      <div style="border-top: 0.1mm solid grey; border-bottom: 0.1mm solid grey; width: 1.5cm; display: table-cell; padding-left: 2mm; padding-right: 2mm; border-left: 0.1mm solid grey; text-align: right">
        <?php print $bricks_bill_table_header_quanti; ?>
      </div>
      <div style="border-top: 0.1mm solid grey; border-bottom: 0.1mm solid grey; width: 2.25cm; display: table-cell; padding-left: 2mm; padding-right: 2mm; border-left: 0.1mm solid grey; text-align: right">
    ...
    <div class="bill-items" style="border-bottom: 0.1mm solid grey; border-top: 0.1mm solid grey; display: table-row; position: relative; width: 100%; font-weight: bold">
      ...
      <div style="border-bottom: 0.1mm solid grey; width: 5.0cm; display: table-cell; padding-left: 2mm; padding-right: 2mm">
        <?php print ' '; ?>
      </div>
      <div style="border-bottom: 0.1mm solid grey; width: 1.5cm; display: table-cell; padding-left: 2mm; padding-right: 2mm">
        <?php print ' '; ?>
      </div>
      <div style="border-bottom: 0.1mm solid grey; width: 2.25cm; display: table-cell; padding-left: 2mm; padding-right: 2mm; text-align: right">
        <?php print $bricks_bill_sub_total; ?>
      </div>
      <div style="border-bottom: 0.1mm solid grey; width: 2.25cm; display: table-cell; border-left: 0.1mm solid grey; text-align: right; padding-left: 2mm; padding-right: 2mm">
        <?php print number_format(($content['field_sub_total']['und'][0]["value"] * ($add_vat ==1 ? 0.81 : 1)), 2, ',', '.'); ?> €
      </div>
    </div> 
    ...
    <div class="bill-items" style="border-bottom: 0.1mm solid grey; border-top: 0.1mm solid grey; display: table-row; position: relative; width: 100%; font-weight: bold">
      ...
      <div style="border-bottom: 0.1mm solid grey; width: 2.25cm; display: table-cell; border-left: 0.1mm solid grey; text-align: right; padding-left: 2mm; padding-right: 2mm">
        <?php print number_format(($content['field_sub_total']['und'][0]["value"]*0.19), 2, ',', '.'); ?> €
      </div>
    </div>
    <?php endif; ?>
    ...
    <div class="bill-items" style="border-bottom: 0.1mm solid grey; border-top: 0.1mm solid grey; display: table-row; position: relative; width: 100%; font-weight: bold">
      ...
      <div style="border-bottom: 0.1mm solid grey; width: 2.25cm; display: table-cell; border-left: 0.1mm solid grey; text-align: right; padding-left: 2mm; padding-right: 2mm">
        <?php print number_format($content['field_grand_total']['und'][0]["value"], 2, ',', '.'); ?> €
      </div>
    </div>
    ...
    <div class="bill-items" style="border-bottom: 0.1mm solid grey; border-top: 0.1mm solid grey; display: table-row; position: relative; width: 100%; font-weight: bold">
      ...
      <div style="border-bottom: 0.1mm solid grey; width: 0.25cm; display: table-cell; padding-left: 2mm; padding-right: 2mm">
        <?php print ' '; ?>
      </div>
      <div style="border-bottom: 0.1mm solid grey; width: 3.5cm; display: table-cell; padding-left: 2mm; padding-right: 2mm; text-align: right">
  ...
  <div style="display: table; position: absolute; bottom: 2.0cm; border-bottom: 0.1mm solid grey; border-top: 0.1mm solid grey; width: 100%;">
    <div style="display: table-row; height: 2.5cm; color: #666666">
      <div style="border-left: 0.1mm solid grey; display: table-cell; width: 5.0cm; padding-left: 2mm; padding-right: 2mm;">
      ...
      <div style="border-right: 0.1mm solid grey; display: table-cell; border-left: 0.1mm solid grey; padding-left: 2mm; padding-right: 2mm;">
